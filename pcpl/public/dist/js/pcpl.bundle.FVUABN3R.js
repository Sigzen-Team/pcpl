(() => {
  // ../pcpl/pcpl/public/js/trial_balance_for_party.js
  ...
  finbyzerp.view_party_ledger_report = {
    view_party_ledger_report: function(company, from_date, to_date, account, party_type, party) {
      let url = window.location.href.split("app")[0] + "app/query-report/General Ledger/?company=" + encodeURIComponent(company) + "&from_date=" + encodeURIComponent(from_date) + "&to_date=" + encodeURIComponent(to_date) + (account ? "&account=" + encodeURIComponent(account) : "") + "&party_type=" + encodeURIComponent(party_type) + "&party=" + encodeURIComponent(party);
      window.open(url, "_blank");
    }
  };
})();
//# sourceMappingURL=pcpl.bundle.FVUABN3R.js.map
